...
import { Mail, Lock, Eye, EyeOff, Phone } from "lucide-react"; // Import new icons
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center bg-white p-8">
        <div className="max-w-[460px] mx-auto w-full flex flex-col gap-y-6">
          ...
          <form className="flex flex-col gap-y-4">
            ...
            {/* Phone number */}
            <div className="flex flex-col gap-y-2">
              <label className="font-inter font-medium">phone number</label>
              <div className="relative">
            ...
            {/* confirm password */}
            <div className="flex flex-col gap-y-2">
              <label className="font-inter font-medium">Confirm Password</label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5" />
                <input
                  type={showPassword ? "text" : "password"}
...
<div className="flex gap-x-4">
    ...
    <span className="font-inter  text-right cursor-pointer hover:underline text-sm">
              I agree to the <span className="text-[#1E88E5]">Terms & Conditions</span> and <span className="text-[#1E88E5]">Privacy Policy</span>
            </span>
