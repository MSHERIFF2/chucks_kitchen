...
export default function CardChef({ title, image, desc, price }: CardProperties) {
  return (
    ...
    <div className="flex flex-col rounded-[14px] bg-white border border-gray-100 shadow-sm h-[480px] w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.33%-2rem)] overflow-hidden">
      ...
      <div className="flex flex-col flex-1 p-4 justify-between">
        ...
        <div className="flex flex-row items-center justify-between gap-3 mt-4">
          ...
          <button className="flex-1 bg-[#FF7A18] hover:bg-[#e66d15] transition-colors rounded-[10px] py-3 px-4 font-inter font-semibold text-white text-[0.875rem] whitespace-nowrap">
            Add to Cart
          </button>
        </div>
      </div>
